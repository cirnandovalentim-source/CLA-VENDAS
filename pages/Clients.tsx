...
const Clients: React.FC = () => {
  ...
  return (
    <div className="p-5 animate-fade-in space-y-4">
      ...
      <Modal isOpen={isImportModalOpen} onClose={() => setIsImportModalOpen(false)} title="Importar Clientes">
         <div className="space-y-4">
             ...
             <div className="bg-emerald-500/10 p-4 rounded-xl border border-emerald-500/20 text-emerald-800 dark:text-emerald-200">
                ...
                <p className="text-xs text-emerald-700 dark:text-emerald-300 mb-3">
                  Importe clientes inserindo o link da planilha ou conectando com sua conta do Google Drive.
                </p>
                <Button 
                  fullWidth 
